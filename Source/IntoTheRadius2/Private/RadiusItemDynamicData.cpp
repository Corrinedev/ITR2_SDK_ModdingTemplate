...
int32 URadiusItemDynamicData::GetStackedItemsNum() const {
    return 0;
}

TArray<FStackedItem> URadiusItemDynamicData::GetStackedItems() const {
    return TArray<FStackedItem>();
}

int32 URadiusItemDynamicData::GetStackedAmmoAmount() const {
    return 0;
}
