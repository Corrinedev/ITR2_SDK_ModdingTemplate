...
void UFLItems::RegenerateItemUniqueId(ARadiusItemBase* Item) {
}
...
void UFLItems::KillContainerChildren(UObject* WorldContext, const FString& ContainerID, const bool bKillItemActors, const bool bKillDynamicData) {
}

void UFLItems::KillContainerAndAllChildren(UObject* WorldContext, const FString& ContainerID, const bool bKillItemActors, const bool bKillDynamicData) {
}
...
bool UFLItems::IsItemOnShopShelf(AActor* ItemActor) {
    return false;
}
