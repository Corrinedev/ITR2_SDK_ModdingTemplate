...
bool ARadiusGameDataReplicator::SetGlobalTrigger(const FGameplayTag Trigger, const bool bSet) {
    return false;
}
...
void ARadiusGameDataReplicator::PrintItemDynamicData(const bool bForcePrint) const {
}

FString ARadiusGameDataReplicator::GetItemDynamicDataLog(const bool bActorReferences) const {
    return TEXT("");
}
...
bool ARadiusGameDataReplicator::CheckGlobalTrigger(const FGameplayTag Trigger) const {
    return false;
}
