...
AActor* UFLSpawn::SpawnPooledActor(const UObject* WorldContextObject, const TSoftClassPtr<AActor> ActorClass, const FTransform Transform, FItemConfiguration ItemConfiguration, const bool bCreateDynamicData) {
    return NULL;
}
