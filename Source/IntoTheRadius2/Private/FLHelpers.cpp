...
bool UFLHelpers::TagContainerHasAllExact(const FGameplayTagContainer& ContainerToCheck, const TArray<FGameplayTag>& TagsToCheck) {
    return false;
}
...
FText UFLHelpers::ReplaceButtonTags(const UObject* WorldContextObject, const FText& Source) {
...
AActor* UFLHelpers::GetTopParentActor(AActor* Actor) {
    return NULL;
}
...
FInputActionTableRow UFLHelpers::FindFirstInputAction(const UObject* WorldContextObject, const FText& Source) {
    return FInputActionTableRow{};
}

TArray<AActor*> UFLHelpers::FindActorsByTag(const TArray<AActor*>& Actors, const FName& Tag) {
    return TArray<AActor*>();
}

FText UFLHelpers::ApplyStyleFormatting(const FText& Source, const FString& BaseStyle, const FString& BoldStyle, const FString& ItalicStyle) {
    return FText::GetEmpty();
}

void UFLHelpers::ScrollToWidget(UScrollBox* ScrollBox, const UWidget* WidgetToScroll) {
}

void UFLHelpers::RemoveAllChildrenFromScrollBox(UScrollBox* ScrollBox) {
}

void UFLHelpers::RemoveAllChildrenFromWidget(UWidget* Widget) {
}
