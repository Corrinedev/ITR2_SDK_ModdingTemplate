...
UNPCConfig::UNPCConfig() {
    ...
    this->LightSourceOnDistanceMultiplier = 1.00f;
    this->LightSourceOnSpotTimeMultiplier = 1.00f;
    this->LightSourceMinIntensity = 0.00f;
    this->LightSourceMaxIntensity = 10000.00f;
    this->LightSourceMinDistance = 0.00f;
    this->LightSourceMaxDistance = 10000.00f;
}
