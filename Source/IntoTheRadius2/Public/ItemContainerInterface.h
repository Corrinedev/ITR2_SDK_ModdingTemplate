...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    bool ShouldDisableHandSocketsFromItem(AActor* Item, const bool bMain) const;
    ...
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    APawn* GetContainerOwningPawn() const;
    ...
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
    FGameplayTagContainer GetContainerAcceptedTags() const;
