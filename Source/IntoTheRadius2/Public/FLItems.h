...
public:
    ...
    static void RegenerateItemUniqueId(ARadiusItemBase* Item);
    ...
    static void KillContainerChildren(UObject* WorldContext, const FString& ContainerID, const bool bKillItemActors, const bool bKillDynamicData);

    UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContext"))
    static void KillContainerAndAllChildren(UObject* WorldContext, const FString& ContainerID, const bool bKillItemActors, const bool bKillDynamicData);
    ...
    static bool IsItemOnShopShelf(AActor* ItemActor);
