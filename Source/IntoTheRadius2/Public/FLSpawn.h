...
public:
    ...
    static AActor* SpawnPooledActor(const UObject* WorldContextObject, const TSoftClassPtr<AActor> ActorClass, const FTransform Transform, FItemConfiguration ItemConfiguration, const bool bCreateDynamicData);
