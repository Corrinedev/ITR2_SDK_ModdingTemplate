...
public:
    ...
    UFUNCTION(BlueprintCallable)
    bool SetGlobalTrigger(const FGameplayTag Trigger, const bool bSet);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure=false)
    void PrintItemDynamicData(const bool bForcePrint) const;

    UFUNCTION(BlueprintCallable, BlueprintPure)
    FString GetItemDynamicDataLog(const bool bActorReferences) const;
...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool CheckGlobalTrigger(const FGameplayTag Trigger) const;
