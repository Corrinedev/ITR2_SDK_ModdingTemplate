...
protected:
    ...
    class URadiusFirearmComponent* OwnerRadiusFirearmComponent;

    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    class UPrimitiveComponent* InternalBulletComponent;
