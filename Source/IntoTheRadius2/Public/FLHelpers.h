...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static bool TagContainerHasAllExact(const FGameplayTagContainer& ContainerToCheck, const TArray<FGameplayTag>& TagsToCheck);
    ...
    static FText ReplaceButtonTags(const UObject* WorldContextObject, const FText& Source);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static AActor* GetTopParentActor(AActor* Actor);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure, meta=(WorldContext="WorldContextObject"))
    static FInputActionTableRow FindFirstInputAction(const UObject* WorldContextObject, const FText& Source);

    UFUNCTION(BlueprintCallable, BlueprintPure)
    static TArray<AActor*> FindActorsByTag(const TArray<AActor*>& Actors, const FName& Tag);

    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FText ApplyStyleFormatting(const FText& Source, const FString& BaseStyle, const FString& BoldStyle, const FString& ItalicStyle);

    UFUNCTION(BlueprintCallable)
    static void ScrollToWidget(UScrollBox* ScrollBox, const UWidget* WidgetToScroll);

    UFUNCTION(BlueprintCallable)
    static void RemoveAllChildrenFromScrollBox(UScrollBox* ScrollBox);

    UFUNCTION(BlueprintCallable)
    static void RemoveAllChildrenFromWidget(UWidget* Widget);
